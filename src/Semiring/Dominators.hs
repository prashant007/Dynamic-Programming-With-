...
-- Decide whether a value component is supportive of a decision
--
-- class (Semiring a,Eq b,Num b) => Support a b where
--   supportive ::  a -> Bool
--   supportive x = x <+> one == x
